...
const toolCall = {
  ...
  instrumentations: [
    ...
    {
      channelName: 'nr_call',
      module: { name: '@langchain/core', versionRange: '>=0.2.0 <0.2.16', filePath: 'dist/tools.cjs' },
      functionQuery: {
    ...
    {
      channelName: 'nr_call',
      module: { name: '@langchain/core', versionRange: '>=0.2.16', filePath: 'dist/tools/index.cjs' },
      functionQuery: {
        className: 'StructuredTool',
        methodName: 'call',
        kind: 'Async'
    ...
    {
      channelName: 'nr_call',
      module: { name: '@langchain/core', versionRange: '>=0.2.0 <0.2.16', filePath: 'dist/tools.js' },
      functionQuery: {
        className: 'StructuredTool',
        methodName: 'call',
        kind: 'Async'
    ...
    {
      channelName: 'nr_call',
      module: { name: '@langchain/core', versionRange: '>=0.2.16', filePath: 'dist/tools/index.js' },
      functionQuery: {
        className: 'StructuredTool',
        methodName: 'call',
        kind: 'Async'
