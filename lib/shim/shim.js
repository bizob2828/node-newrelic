...
function getSegment(obj) {
  if (this._agent.config.feature_flag.use_legacy_context) {
...
function storeSegment(obj, segment) {
  // TODO: we want to remove this but there are sitll uses cases that need to attach a segment to object
  // think about other ways of doing this
  if (this._agent.config.feature_flag.use_legacy_context) {
