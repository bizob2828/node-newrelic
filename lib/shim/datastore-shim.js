...
function recordOperation(nodule, properties, opSpec) {
  ...
  // TODO: this isn't finding the active segment
 ...
 * @param {Transaction}  transaction - The transaction being recorded.
 */
 ...
 * @see MetricFunction
 */
function _recordOperationMetrics(segment, scope, transaction) {
  if (!(segment || transaction)) {
    return
  }
