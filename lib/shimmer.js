...
const shimmer = (module.exports = {
  ...
  bootstrapInstrumentation: function bootstrapInstrumentation(agent) {
    ...
    // The location of this must be here
    // I cannot figure out why but the weak references to the channel subscriptions get cleaned up
    // when pre-defined before undici loads.
    // See: https://github.com/nodejs/node/issues/43915
