 ...
 */
function recordVectorSearch({ request, k, output, agent, shim, segment, transaction, pkgVersion, err }) {
    ...
    function wrapCall(shim, similaritySearch, fnName, args) {
      ...
      return new RecorderSpec({
        ...
        after({ error: err, result: output, segment, transaction }) {
          ...
          recordVectorSearch({ request, k, output, agent, shim, segment, transaction, pkgVersion, err })
