...
const { context, trace, TraceFlags, SamplingDecision } = require('@opentelemetry/api')
const { NrSpan } = require('./nr-span.js')
const { toHrTime } = require('../utils/hr-time.js')
...
class NrTracer {
  ...
  startSpan(name, options = {}, ctx) {
    ...
    console.log(traceId.length, spanId.length)
