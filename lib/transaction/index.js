...
function Transaction(agent, traceId) {
  ...
  if (securityChannels.transactionStart.hasSubscribers) {
    securityChannels.transactionStart.publish({ transaction: this, id: this.id, type: this.type })
  }
}
...
Transaction.prototype.end = function end() {
  ...
  if (securityChannels.transactionFinish.hasSubscribers) {
    securityChannels.transactionFinish.publish({ transaction: this, id: this.id, type: this.type })
  }
