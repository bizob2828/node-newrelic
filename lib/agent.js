...
/**
 * No-op: agent commands are now delivered in-band via collector response
 * payloads and processed by `CollectorAPI._handleResponseCode`, so the
 * polling loop is no longer started.
 */
