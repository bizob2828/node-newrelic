...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.1001.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.1001.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.1001.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.1001.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.1001.0 | 8.7.1 |
| `@aws-sdk/smithy-client` | 3.47.0 | 3.374.0 | 8.7.1 |
| `@azure/functions` | 4.7.0 | 4.11.2 | 12.18.0 |
| `@elastic/elasticsearch` | 7.16.0 | 9.3.3 | 11.9.0 |
...
| `@langchain/core` | 0.2.0 | 1.1.30 | 11.13.0 |
