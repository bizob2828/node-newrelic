...
| `@aws-sdk/client-bedrock-runtime` | 3.474.0 | 3.953.0 | 11.13.0 |
| `@aws-sdk/client-dynamodb` | 3.0.0 | 3.953.0 | 8.7.1 |
| `@aws-sdk/client-sns` | 3.0.0 | 3.953.0 | 8.7.1 |
| `@aws-sdk/client-sqs` | 3.0.0 | 3.953.0 | 8.7.1 |
| `@aws-sdk/lib-dynamodb` | 3.377.0 | 3.953.0 | 8.7.1 |
...
| `@langchain/core` | 0.1.17 | 1.1.6 | 11.13.0 |
...
| `@smithy/smithy-client` | 2.0.0 | 4.10.1 | 11.0.0 |
